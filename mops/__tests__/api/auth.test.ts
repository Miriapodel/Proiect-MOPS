...
describe('Auth API Endpoint Contracts (Register/Login)', () => {
  ...
  describe('Login token contract', () => {
    it('should define expected login success response structure', () => {
    ...
    it('should recommend using HttpOnly cookie for refresh token', () => {
  ...
  describe('Register input validation contract (basic)', () => {
    ...
    it('should treat emails case-insensitively for uniqueness', () => {
      const emailA = 'User@Alex.com'.toLowerCase();
      const emailB = 'user@alex.com'.toLowerCase();
